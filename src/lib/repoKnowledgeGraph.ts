...
export const repoGraphNodes: RepoGraphNode[] = [
  ...
  { id: "supabase_client", label: "Supabase client", type: "client", group: "frontend" },
...
export const repoGraphEdges: RepoGraphEdge[] = [
  ...
  { source: "repo_graph_page", target: "supabase_client", label: "maps" },
  { source: "dashboard", target: "supabase_client", label: "queries" },
  { source: "gke_dashboard", target: "supabase_client", label: "queries" },
  { source: "monitoring_agent_page", target: "supabase_client", label: "queries" },
  { source: "alerts_page", target: "supabase_client", label: "mutates" },
  { source: "logs_page", target: "supabase_client", label: "queries" },
  { source: "jira_page", target: "supabase_client", label: "mutates" },
  { source: "cost_dashboard", target: "supabase_client", label: "queries" },
  { source: "security_analyzer", target: "supabase_client", label: "queries" },
  { source: "plugin_marketplace", target: "plugin_registry", label: "reads" },
  { source: "supabase_client", target: "monitoring_agents", label: "reads" },
  { source: "supabase_client", target: "collected_logs", label: "reads" },
  { source: "supabase_client", target: "collected_metrics", label: "reads" },
  { source: "supabase_client", target: "collected_events", label: "reads" },
  { source: "supabase_client", target: "alert_rules", label: "CRUD" },
  { source: "supabase_client", target: "triggered_alerts", label: "updates" },
  { source: "supabase_client", target: "notification_channels", label: "CRUD" },
  { source: "supabase_client", target: "jira_automation_settings", label: "upserts" },
  { source: "supabase_client", target: "jira_resource_tickets", label: "reads" },
